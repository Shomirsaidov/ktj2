    ...
    <div class="flex justify-center">
        <div class="card p-4 px-8 md:px-32 md:mt-16 border-2 rounded-md shadow-xl space-y-4 w-full lg:max-w-2xl" v-if="!loginScreen">
            ...
            <div class="flex justify-end">
                <button @click="signup" class="bg-blue-600 text-white p-2 rounded-lg mt-2 text-lg w-full">Далее</button>
            </div>
        ...
        <div class="card p-4 px-8 md:px-32 md:mt-16 border-2 rounded-md shadow-xl space-y-4 w-full lg:max-w-2xl" v-if="loginScreen">
            ...
            <input v-model="telLogin" type="text" placeholder="Номер телефона" class="p-2 border-2 rounded-lg text-lg outline-none w-full"><br/>
            <input v-model="passwordLogin" type="password" placeholder="Пароль" class="p-2 border-2 rounded-lg text-lg outline-none w-full">
            <div class="flex justify-end">
                <button @click="login" class="bg-blue-600 text-white p-2 rounded-lg mt-2 text-lg w-full">Войти</button>
            </div>
